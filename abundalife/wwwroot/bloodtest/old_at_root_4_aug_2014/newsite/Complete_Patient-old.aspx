<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Complete_Patient-old.aspx.cs"
    Inherits="abundalife1001.Complete_Patient" %>
        ...
        <tr>
            ...
            <td width="60%" align="center" valign="top">
                <table width="66%" border="3" cellpadding="0" cellspacing="0" bordercolor="#FF6600">
                    <tr>
                        <td height="678" align="center" valign="top" bgcolor="#CCCC33">
                                                    ...
                                                    <div align="left">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td valign="top">
                                                                    <div align="center">
                                                                        <img src="images/TopMenuMain.gif" width="486" height="97" border="0" usemap="#Map" />
                                                                        <map name="Map" id="Map">
                                                                            <area shape="poly" coords="124,70,110,71,107,82,116,92,136,95,179,93,228,94,274,91,268,82,279,71,215,71,126,73,419,72"
                                                                                href="#" />
                                                                            <area shape="poly" coords="415,74,375,73,313,72,278,73,270,82,275,92,333,93,379,93,421,92,414,82,414,74"
                                                                                href="#" />
                                                                            <area shape="poly" coords="483,73,451,71,417,72,415,86,420,95,477,92,472,147,486,84,477,73"
                                                                                href="#" />
                                                                            <area shape="poly" coords="109,71,91,71,70,71,57,82,65,94,85,94,114,93,105,80,108,70"
                                                                                href="#" />
                                                                            <area shape="poly" coords="2,94,4,72,21,70,44,71,71,71,56,85,63,94,29,97,3,90" href="#" />
                                                                            <area shape="rect" coords="3,43,69,67" href="#" />
                                                                        </map>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td valign="top">
                                                                    <div align="left">
                                                                        <table width="100%" border="5" cellpadding="5" cellspacing="0" bordercolor="#CCCC33">
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <table width="100%" border="2" cellpadding="5" cellspacing="0" bordercolor="#F36D1B">
                                                                                        <tr>
                                                                                            <td class="style3">
                                                                                                Last Name:
                                                                                            </td>
                                                                                    ...
                                                                                    <ul id="MenuBar1" class="MenuBarVertical">
                                                                                        ...
                                                                                        <li><a class="MenuBarItemSubmenu" href="#">Clinical Alternative Therapy Checklist</a>
                                                                                            ...
                                                                                            <ul>
                                                                                                <li><a href="javascript:Delegator('ECAT');">Enter Clinical Alternative Therapy</a>
                                                                                                </li>
...
<!--
        ...
        function Delegator(xthis) {
            if (xthis == 'EBU') {
                ...
                window.location = 'UrineReport.aspx?ID=' + document.form1.xid.value;
            } else if (xthis == 'VPUS') {
                ...
                window.location = 'Final-Result-Key.aspx?ID=' + document.form1.xid.value;
            } else if (xthis == 'VPCC') {
