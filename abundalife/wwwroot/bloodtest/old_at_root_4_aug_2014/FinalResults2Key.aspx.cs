...
{
    public partial class FinalResults2Key : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         " where id = " + Convert.ToInt32(HttpContext.Current.Request.QueryString["ID"]);
            ...
            if (Page.IsPostBack)
            {
                ...
                string cb = "INSERT INTO customers_results2(customer_id,one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve)" +
                ...
                Response.Redirect("FinalResults2Print.aspx?ID=" + Request.Form["xid"]);
