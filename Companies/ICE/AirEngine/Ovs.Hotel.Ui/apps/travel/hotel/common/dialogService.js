    ...
    function dialogService() {
        ...
        this.showDialog = function (title, message) {
            if (this.dialogWidget != null) {
                ...
                this.dialogWidget.content("<p>" + message + "</p><div style='text-align:center; margin-top: 10px'><button class='k-button' ng-click=\"main.closeDialog();\">Close</button>");
      ...
      this.showContent = function (title, content) {
            if (this.contentWidget != null) {
                ...
                this.contentWidget.content("<p>" + content + "</p><div style='text-align:center; margin-top: 10px'><button class='k-button' ng-click=\"main.closeContent();\">Close</button>");
