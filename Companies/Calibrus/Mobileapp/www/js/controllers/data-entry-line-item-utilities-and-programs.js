...
angular.module('calibrus')
  .controller('DataEntryLineItemUtilitiesAndProgramsCtrl', function ($state, $ionicPopup, $filter, calibrusSparkRequestService, enrollmentService, userService) {
    var vm = this;
    ...
    vm.refreshUtilitiesAndPrograms = function () {
      ...
      return calibrusSparkRequestService.getUtilityPrograms(user.vendorId, user.officeId, state, zip)
