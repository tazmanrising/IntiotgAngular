...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').each(function() {
        ...
        tjq(this).datepicker({
            showOn: 'button',
            buttonImage: '/apps/assets/images/icon/blank.png',
            buttonText: '',
...
// login box
tjq("body").on("click", ".ovs-signup-box .signup-email", function(e) {
    e.preventDefault();
    tjq(this).closest(".ovs-signup-box").find(".simple-signup").hide();
    tjq(this).closest(".ovs-signup-box").find(".email-signup").show();
    tjq(this).closest(".ovs-signup-box").find(".email-signup").find(".input-text").eq(0).focus();
});
