    ...
    $.fn.visualize = function (options, container) {
        return $(this).each(function () {
            ...
            var o = $.extend({
                ...
                height: '400px', //height of canvas - defaults to table height // $(this).height() - By Developer
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
                rowFilter: ' ',
                colFilter: ' ',
                colors: ['#ee8310', '#8d10ee', '#5a3b16', '#26a4ed', '#f45a90', '#e9e744', '#be1e2d', '#666699', '#92d5ea'],
                ...
                yLabelInterval: 15 //distance between y labels
            }, options);
                ...
                bar: function () {
                    ...
                    $.each(yLabels, function (i) {
                        ...
                        if (label.html() == "0") {
                            label
                                .html("Waiting to die")
                                .css('margin-top', topOffset + 6);
                        }
                        else if (label.html() == "1")
                            label.html("Big Pharma Cash Cow to Longterm medical Dificiences");
                        else if (label.html() == "2")
                            label.html("Nutritionally exhausted Premature Aging");
                        else if (label.html() == "3")
                            label.html("Nutritionally depleted");
                        else if (label.html() == "4")
                            label.html("Less than Optimal");
                        else if (label.html() == "5") {
                            label
                                .html("Optimal Health")
                                .css('margin-top', topOffset - 6);
                        }
