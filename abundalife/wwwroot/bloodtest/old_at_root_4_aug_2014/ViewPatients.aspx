<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPatients.aspx.cs" Inherits="abundalife1001.ViewPatients" %>
...
<asp:TemplateField HeaderText="Visit" >
    <ItemTemplate>
        <asp:LinkButton id="id" OnCommand="lnkButton_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"id") %>' runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"id","Visit") %>'></asp:LinkButton>
    </ItemTemplate>
</asp:TemplateField>
