...
{
    public partial class Insert_Profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack)
            {
                ...
                string cb = "INSERT INTO customers_blood(customer_id,glucose,bun,creatine,buncreatineratio,sodium,potassium," +
                    ...
                    "values(" + Request.Form["xid"] + ",\'" + Request.Form["glucose"] + "\',\'" + Request.Form["bun"] + "\',\'" + Request.Form["creatine"] + "\',\'" +
                ...
                string cu = "Insert into customers_urine(customer_id,ascorbicacid,color,specificGravity,PHNegative,UrineGlucose,Bilirubin," +
                    ...
                    "values(" + Request.Form["xid"] + ",\'" + Request.Form["ascorbicacid"] + "\',\'" + Request.Form["color"] + "\',\'" + Request.Form["specificGravity"] + "\',\'" +
                ...
                "fibbinogen,ca125)values(" + Request.Form["xid"] + ",\'" + Request.Form["sugarrefractometer"] + "\',\'" + Request.Form["conductivity"] + "\',\'" +
               ...
               "values(" + Request.Form["xid"] + ",\'" + Request.Form["FRUCTOSAMINE"] + "\',\'" + 
                ...
                Response.Redirect("BloodReports.aspx?ID=" + Request.Form["xid"]);
